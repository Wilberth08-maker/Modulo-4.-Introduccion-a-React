...
const AlojamientoDetalles = () => {
    ...
    useEffect(() => {
        ...
        const fetchAlojamientoDetalles = async () => {
            try {
                ...
                console.error('Error cargando detalles del alojamiento:', err);
    ...
    if (!alojamiento) {
        return <div className="text-center py-10 text-gray-700">Alojamiento no disponible.</div>;
    }

    // 
    return (
        <div className="container mx-auto p-4 md:p-8 lg:p-12 max-w-5xl bg-white shadow-lg rounded-lg my-8">
            ...
            <p className="text-lg text-gray-600 mb-6 flex items-center">
                ...
                {alojamiento.ubicacion} &middot; <span className="ml-1 text-gray-700 font-medium">{alojamiento.calificacion} ★</span>
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                ...
                <div className="md:col-span-2">
                    ...
                    <div className="border-t border-b border-gray-200 py-6 mb-6">
                        <div className="flex items-center mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-700 mr-3" fill="none" viewBox="0 0 32 32" stroke="currentColor" strokeWidth="2">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900">Espacio exterior increible</h3>
                                <p className="text-sm text-gray-600">Los huéspedes mencionan alberca como un punto destacado.</p>
                            </div>
                        </div>
                        <div className="flex items-center mb-4">
                            <svg 
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900">Llegada autónoma</h3>
                                <p className="text-sm text-gray-600">Para entrar al alojamiento, usa la caja de seguridad para llaves.</p>
                            </div>                              
                        </div>
                        <div className="flex items-center">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900">Excelente ubicación</h3>
                                <p className="text-sm text-gray-600">A los huéspedes que se quedaron aquí el año pasado les encantó la ubicación.</p>
                            </div>                              
                        </div>
                    </div>
                </div>
                ...
                <div className="md:col-span-1">
                    <div className="sticky top-20 border border-gray-200 rounded-xl p-6 shadow-md">
                        <div className="flex justify-between items-center mb-4">
                            <span className="text-2xl font-semibold text-gray-900">${alojamiento.precio}</span>
                        ...
                        <p className="text-center text-sm text-gray-500 mt-2">No se te cobrará nada aún</p>
                    </div>
                </div>
            </div>
