        ...
        {/* Apartados centrales con videos */}
            <div className="hidden md:flex items-center space-x-8 mx-auto">
                ...
                className={`flex items-center pb-1 transition-colors duration-200 relative group
                    ...
                    ? 'text-gray-900 font-bold'
                    : 'text-gray-700 hover:text-gray-900 font-large'
                    }`}
                >
            ...
            <div className="flex items-center space-x-2">
                <button
                    className="hidden md:block text-gray-700 hover:bg-gray-100 font-semibold py-2 px-3 rounded-full transition-colors duration-200"
                >
                    Conviértete en anfitrión
                </button>

                <button
                    className="w-10 h-10 flex items-center justify-center bg-gray-200 border border-gray-300 rounded-full shadow-sm text-gray-700 hover:shadow-md transition-shadow duration-200 focus:outline-none focus:ring-opacity-50"
                >
                    <svg
                        ...
                        <div className="absolute right-0 mt-3 w-48 bg-white border border-gray-200 rounded-xl shadow-lg py-2 z-20 animate-fadeInUp">
                            <span className="block px-4 py-2 text-gray-700 text-sm truncate">Hola, **{user.email.split('@')[0]}**</span>
                                    ...
                                    <Link
                                        to="/signup"
                                        onClick={() => setIsMenuOpen(false)}
                                        className="block px-4 py-2 text-gray-800 font-semibold hover:bg-gray-100 rounded-lg transition-colors duration-200"
                                    >
                                        Registrarse
                                    </Link>
